...
<body>
        ...
        <div class="sidebar">
            ...
            <nav class="menu">
                <ul>
                    ...
                    <li><div class="menu-item" id="messages"><img src="resources/messages.png" width="30" height="30">메시지</div></li>
                    ...
                    <li><div class="menu-item" id="profile"><img src="resources/unknown.jpg" width="30" height="30">프로필</div></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <script>
        ...
        document.getElementById('profile').onclick = function(){
        	location.href="/reMerge/mypage.us"
        };
    </script>
