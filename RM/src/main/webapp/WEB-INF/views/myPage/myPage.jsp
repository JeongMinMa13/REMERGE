...
<div>
	<button type="button" class="btn btn-danger" data-bs-toggle="modal"
		data-bs-target="#deleteModalSm">회원탈퇴</button>
...
<div class="modal fade" id="deleteForm" tabindex="-1"
	aria-labelledby="deleteModalSmLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="deleteModalSmLabel">회원탈퇴</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal"
					aria-label="Close"></button>
			</div>
			<div class="modal-body">정말로 탈퇴하시겠습니까? 탈퇴 후에는 복구할 수 없습니다.</div>
			<div class="modal-footer">
